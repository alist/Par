#import "DefParseCal.h"
#import "DebugPrint.h"
#define PrintDefCalParse(...) DebugPrint(__VA_ARGS__)

void DefParseCal::initParToks() {
...
void DefParseCal::deleteParToks() {
...
void DefParseCal::parseBuf(const char*buf, bool print) {
